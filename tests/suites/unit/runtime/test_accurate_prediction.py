"""Contract tests for accurate prediction/probability helper functions."""
...
def test_predict_labels_returns_row_aligned_strings() -> None:
    """Predict helper should coerce model labels to strings."""
...
def test_confidence_and_probabilities_falls_back_without_predict_proba() -> None:
    ...
    confidences, probabilities = confidence_and_probabilities(
        ...
        features=_features(),
        expected_rows=2,
        logger=logging.getLogger("tests.accurate_prediction"),
    )
