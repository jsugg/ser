...
def test_build_stable_whisper_transcribe_kwargs_prefers_denoiser_when_available() -> None:
...
def test_build_stable_whisper_transcribe_kwargs_uses_demucs_flag_when_supported() -> None:
...
def test_stable_whisper_adapter_build_transcribe_kwargs_delegates_to_helper(
    ...
    def _fake_build_kwargs(
        *,
        ...
        captured["supports_fp16"] = supports_keyword_argument(transcribe_callable, "fp16")
