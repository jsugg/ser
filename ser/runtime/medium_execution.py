"""Medium-profile execution helpers for the encode/pool/predict pipeline."""
...
class LoadedModelLike(Protocol):
    """Loaded-model contract required for medium execution."""
...
def run_medium_inference_once(
    *,
    ...
    """Run the pure medium execution pipeline once for an encoded sequence."""
